---
publishDate: 2024-09-27T10:20:05
title: 使用Vue.js自製響應式Swiper
excerpt: 有時於專案中，需要製作卡片切換器，第一個想到的就是Swiper.js，而這切換器功能，其實不會非常複雜，自己也能在短時間內，把需求實現出來，同時包含響應式功能，於小螢幕時顯示1張卡片，於大螢幕時顯示2張卡片。
category: Frontend
tags:
  - javascript
  - vue
...
有時於專案中，需要製作卡片切換器，第一個想到的就是Swiper.js，而這切換器功能，其實不會很複雜，自己也能在短時間內，把需求實現出來，同時包含響應式功能。
...
<iframe
  ...
  style="width: 100%;"
  scrolling="no"
  title="Custom RWD Swiper"
  src="https://codepen.io/hanc1027/embed/jOgNXdQ?default-tab=html%2Cresult&editable=true"
  frameborder="no"
  loading="lazy"
  allowtransparency="true"
  allowfullscreen="true"
>
  See the Pen <a href="https://codepen.io/hanc1027/pen/jOgNXdQ">Custom RWD Swiper</a> by Han.C.Hsu (
  <a href="https://codepen.io/hanc1027">@hanc1027</a>) on <a href="https://codepen.io">CodePen</a>.
</iframe>
<br />
...
```html
<div v-for="(person, index) in people" :key="index" class="card flex-shrink-0 w-full md:w-1/2 p-4">...</div>
```
...
<iframe
  ...
  style="width: 100%;"
  scrolling="no"
  title="Custom RWD Swiper - AutoPlay"
  src="https://codepen.io/hanc1027/embed/JjgjqeN?default-tab=html%2Cresult&editable=true"
  frameborder="no"
  loading="lazy"
  allowtransparency="true"
  allowfullscreen="true"
>
  See the Pen <a href="https://codepen.io/hanc1027/pen/JjgjqeN">Custom RWD Swiper - AutoPlay</a> by Han.C.Hsu (
  <a href="https://codepen.io/hanc1027">@hanc1027</a>) on <a href="https://codepen.io">CodePen</a>.
</iframe>
<br />
...
<iframe
  ...
  style="width: 100%;"
  scrolling="no"
  title="Custom RWD Swiper - Rotate"
  src="https://codepen.io/hanc1027/embed/rNXNErY?default-tab=html%2Cresult&editable=true"
  frameborder="no"
  loading="lazy"
  allowtransparency="true"
  allowfullscreen="true"
>
  See the Pen <a href="https://codepen.io/hanc1027/pen/rNXNErY">Custom RWD Swiper - Rotate</a> by Han.C.Hsu (
  <a href="https://codepen.io/hanc1027">@hanc1027</a>) on <a href="https://codepen.io">CodePen</a>.
</iframe>
<br />
...
<div
  v-for="(person, index) in people"
  :key="index"
  class="card flex-shrink-0 w-full p-4"
