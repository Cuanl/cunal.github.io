---
publishDate: 2020-12-25T15:20:05Z
title: 手把手製作Telegram Bot (Node.js + Heroku)
excerpt: 製作聊天機器人不需要很高的門檻，只要有一台電腦、一個telegram帳號，就可以實現啦! 這篇文章將帶大家一步步來製作一個Telegram Bot，並且在Heroku上部署。
image: https://miro.medium.com/v2/resize:fit:830/format:webp/1*oWp_PbhhrfIU2dmNtaApLA.png
category: Backend
tags:
  - javascript
  - telegram
